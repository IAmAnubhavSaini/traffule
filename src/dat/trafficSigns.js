{
  "mandatory": [
    {
      "signName": "NoEntry"
      , "signDescription": "You can not enter."
      , "signCaption": "No Entry"
    },
    {
      "signName": "StopAndGiveWay"
      , "signDescription": "you can not go on this way OR one sided coming traffic only "
      , "signCaption": "Stop and Give way"
    },
    {
      "signName": "GiveWay"
      , "signDescription": "you can not come on this way OR one sided going traffic only"
    ...
    },
    {
      ...
      , "signDescription": "Vehicles must not be higher than the limit"
      , "signCaption": "Height limit"
    },
    {
      "signName": "WidthLimit"
      , "signDescription": "Vehicles must not be wider than the limit"
      , "signCaption": "Width limit"
    },
    {
      "signName": "WeightLimit"
      , "signDescription": "Vehicles must not weight more than the limit."
      , "signCaption": "Gross weight limit"
    },
    {
      "signName": "AxleWeightLimit"
      , "signDescription": "Vehicle axle must not have more load than the limit"
      , "signCaption": "Axle load limit"
    },
    {
      "signName": "StopPass"
      , "signDescription": "Stop completely before passing."
      , "signCaption": "Stop before passing"
    },
    {
      "signName": "NoOvertaking"
      , "signDescription": "Do not overtake vehicles"
      , "signCaption": "No overtaking"
    },
    {
      "signName": "NoHeavyVehicle"
      , "signDescription": "Heavy vehicles like truck, bus etc. are restricted"
      , "signCaption": "No heavy vehicle"
    },
    {
      "signName": "NoRightTurn"
      , "signDescription": "Right turn is prohibited"
      , "signCaption": "No right turn"
    },
    {
      "signName": "NoHandCart"
      , "signDescription": "Hand cart are prohibited"
    ...
    "cautionary": [
      {
        "signName": "CrossRoad"
        , "signDescription": "Road crossess another road ahead"
        , "signCaption": "Cross road"
      },
      {
        "signName": "MajorCrossRoad"
        , "signDescription": "Road crossess a major road ahead"
        , "signCaption": "Major cross road"
      },
      {
        "signName": "RightBranch"
        , "signDescription": "Road branches on the right ahead "
        , "signCaption": "Branch in road on right"
      },
      {
        "signName": "LeftBranch"
        , "signDescription": "Road branches on the left ahead"
        , "signCaption": "Branch in road on left"
      },
      {
        "signName": "StaggardJunction"
        , "signDescription": "Left and right roads ahead"
      ...
      },
      {
        ...
        , "signDescription": "Railway crossing ahead with gate or barrier, wit for gate to be opened."
